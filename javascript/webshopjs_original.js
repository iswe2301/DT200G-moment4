...
* 
* Ändringar gjorda: 
* showCheckout funktionen - lagt till en klass (.artID) på artikel-ID för att kunna dölja denna på skärmar mindre än 600px.
* checkoutBasket funktionen - hämtat ID för formulär och lagt till kontroll/validering på formulär för att se att alla obligatoriska fält är ifyllda innan köpet genomförs. Rapporterar felmeddelanden om false.
*/
